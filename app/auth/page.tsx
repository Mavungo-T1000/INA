  ...
  return (
    <VStack padding={10} width={'100%'} background={'#f6f6f6'}>
        <VStack gap={4} padding={10} background={'white'} borderRadius={20} width={'100%'} maxWidth={400}>
            ...
            <Box width={'100%'}>
                <Text color={'gray'} fontWeight={500} fontSize={12}>Nome</Text>
                <Input onChange={(e)=>{setName(e.target.value)}} color={'black'} background={'#f6f6f6'} borderRadius={20} outline={'none'} fontSize={12} placeholder='Digite seu nome'/>  
            </Box>
            <Box width={'100%'}>
